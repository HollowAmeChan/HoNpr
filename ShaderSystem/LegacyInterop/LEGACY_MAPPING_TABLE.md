...
| `_UseAnisotropy` / `_Anisotropy*` | lilToon/lilPBR anisotropy | `HairSpecularPrimary`, `HairSpecularSecondary`, `PbrSpecularAnisotropic` | Split | 头发 toon 与 PBR anisotropy 不共用旧开关。 |
