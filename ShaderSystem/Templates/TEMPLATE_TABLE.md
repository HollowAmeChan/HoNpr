...
| `MaterialTemplate.CharacterOutline` | `ShaderSystem/Templates/Character/CharacterOutline.honprtemplate` | `ForwardOutlineLilToon` | `SurfaceInput`, `StylizedLobe`, `Transparency` | 已声明 | HoNpr character outline pass shell using the outline-lilToon algorithm variant. |
