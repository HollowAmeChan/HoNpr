...
| `MaterialTemplate.CharacterOutline` | `ShaderSystem/Templates/Character/CharacterOutline.honprtemplate` | `ForwardLilToonOutline` | `SurfaceInput`, `StylizedLobe`, `Transparency` | 已声明 | HoNpr character outline pass shell using the lilToon outline algorithm variant. |
