#ifndef HONPR_ENVIRONMENT_PBR_INCLUDED
#define HONPR_ENVIRONMENT_PBR_INCLUDED
...
#include "Packages/com.hollow.honpr/Shaders/ShaderLibrary/StandardSurface/HoNprPbrLobes.hlsl"
...
#endif
    surface = HoNprApplyMaterialMapPacked(
        surface,
        materialSample,
...
#if defined(HONPR_HAS_PBR_DIFFUSE)
    HoNprAccumulateLobe(lobes, HoNprEvaluatePbrDiffuse(surface, lighting));
#endif
#if defined(HONPR_HAS_PBR_SPECULAR_GGX)
    HoNprAccumulateLobe(lobes, HoNprEvaluatePbrSpecularGGX(surface, lighting, viewDirWS));
#endif
#if defined(HONPR_HAS_PBR_SPECULAR_ANISOTROPIC)
    HoNprAccumulateLobe(lobes, HoNprEvaluatePbrSpecularAnisotropic(surface, lighting, viewDirWS, input.tangentWS, _HoNprAnisotropy, _HoNprAnisotropyMask));
#endif
#if defined(HONPR_HAS_CLEAR_COAT_SPECULAR)
    HoNprAccumulateLobe(lobes, HoNprEvaluateClearCoatSpecular(surface, lighting, viewDirWS, _HoNprClearCoatMask, _HoNprClearCoatRoughness));
#endif
